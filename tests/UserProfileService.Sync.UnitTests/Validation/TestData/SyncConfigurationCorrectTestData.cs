...
namespace UserProfileService.Sync.UnitTests.Validation.TestData
{
    ...
    /// </summary>
    public class SyncConfigurationCorrectTestData : IEnumerable<object[]>
    {
        ...
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[]
            {
                new SyncConfiguration
                {
                    ...
                    {
                        Systems = new Dictionary<string, SourceSystemConfiguration>
                        {
                            {
                                "Ldap", new SourceSystemConfiguration
                                {
                                    Configuration = new GeneralSystemConfiguration
                                    {
                                        LdapConfiguration = new[]
                                        {
                                            new ActiveDirectory
                                            {
                                                ...
                                                {
                                                    ConnectionString = "LDAP://A365DirectoryService.a365dev.de",
                                                    ServiceUserPassword = "1",
                                                    BasePath = "dc=a365dev,dc=de",
                                                    AuthenticationType = "None",
                                                    ServiceUser = "CN=Administrator,CN=Users,DC=A365DEV,DC=DE",
                                                    Description = "Default AD of A365 DEV environment",
                                                    Port = 636,
                                    ...
                                    {
                                        {
                                            "users", new SynchronizationOperations
                                            {
                                                ForceDelete = false,
                                                Operations =
                                                    SynchronizationOperation.Add | SynchronizationOperation.Update
                                            }
                                        }
                                    }
                                }
                        ...
                        Validation = new ValidationConfiguration
                        {
                            Internal = new EntityConfiguration
                            {
                                ...
                                User = new UserValidationConfiguration
                                {
