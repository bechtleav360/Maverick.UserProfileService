...
{
    public class WasAssignedToGroupHandlerTest
    {
        private const string GroupAName = "Gruppe A";
        private const string GroupBName = "Gruppe B";
        private readonly ObjectIdent _groupA = new ObjectIdent(
            "ECD168C9-C3AF-4F31-AA5D-4237A87B9C1C",
            ObjectType.Group);
        private readonly ObjectIdent _groupB = new ObjectIdent(
        ...
        private static WasAssignedToGroup GetNewEvent(
        ...
        {
            WasAssignedToGroup newEvent = new WasAssignedToGroup
            {
        ...
        [Fact]
        public async Task Handle_event_should_add_new_group()
        {
            // arrange
            ...
            var sut = ActivatorUtilities.CreateInstance<WasAssignedToGroupHandler>(services);
            var streamNameResolver = services.GetRequiredService<IStreamNameResolver>();

            WasAssignedToGroup eventToHandle = GetNewEvent(
                services,
                _user.Id,
                _groupA.Id,
                GroupAName,
            ...
            expectedUser.ActiveMemberships.Add(_groupA);
        ...
        public async Task Handle_event_should_add_new_assignment()
        {
            ...
            SecondLevelProjectionAssignmentsUser expectedUser = GetNewUser(_user.Id);
            expectedUser.ActiveMemberships.Add(_groupB);

            SecondLevelProjectionAssignment assignment =
                expectedUser.Assignments.First(a => a.Parent.Id == _groupB.Id && a.Profile.Id == _user.Id);
