...
{
    public class TestingEqualityComparerForConditionalOrganization: TestingEqualityComparerForEntitiesBase<ConditionalOrganization>
    {
        public TestingEqualityComparerForConditionalOrganization(ITestOutputHelper outputHelper) : base(outputHelper)
        {
        }      

        protected override string GetId(ConditionalOrganization input)
        {
            return input.Id;
        }

        protected override bool EqualsInternally(ConditionalOrganization x, ConditionalOrganization y)
        {
            return IsTrue(
                ...
                AddOutput(x.IsActive == y.IsActive, x, y, g => g.IsActive),
                AddOutput(
        ...
        public override int GetHashCode(ConditionalOrganization obj)
        {    unchecked
            {
