...
/// </summary>
public abstract class SecondLevelVolatileDataEventHandlerBase<TEvent> : ISecondLevelVolatileDataEventHandler<TEvent>
    where TEvent : class, IUserProfileServiceEvent
{
    /// <summary>
    ///     The logger to be used by the current instance of <see cref="SecondLevelVolatileDataEventHandlerBase{TEvent}" />.
    ///     implementation.
    /// </summary>
    ...
    /// </summary>
    protected ISecondLevelVolatileDataRepository Repository { get; }

    /// <summary>
    ///     The connected stream name resolver.
    /// </summary>
    public IStreamNameResolver StreamNameResolver { get; }

    /// <summary>
    ///     The default constructor of the <see cref="SecondLevelVolatileDataEventHandlerBase{TEvent}" /> class that will
    ///     accept a
    ///     specified
    ...
    protected SecondLevelVolatileDataEventHandlerBase(
    ...
    protected virtual async Task ExecuteInsideTransactionAsync(
        Func<ISecondLevelVolatileDataRepository, IDatabaseTransaction?, CancellationToken, Task> methodDefinition,
        StreamedEventHeader eventHeader,
        CancellationToken cancellationToken = default)
    {
        Logger.EnterMethod();
