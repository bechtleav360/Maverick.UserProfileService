...
/// <summary>
///     Processes an <see cref="FunctionChanged" /> event.
/// </summary>
public class FunctionChangedEventHandler : SecondLevelEventHandlerBase<FunctionChanged>
{
    /// <summary>
    ...
    public FunctionChangedEventHandler(
        ISecondLevelProjectionRepository repository,
        IMapper mapper,
        IStreamNameResolver streamNameResolver,
        IMessageInformer messageInformer,
        ILogger<FunctionChangedEventHandler> logger) : base(repository, mapper, streamNameResolver, messageInformer, logger)
    {
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (domainEvent.Context == PropertiesChangedContext.SecurityAssignments)
        {
            ...
            {
                { nameof(ILinkedObject.Name), domainEvent.Function.GenerateFunctionName() }
            };
