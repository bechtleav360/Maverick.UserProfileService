...
/// <summary>
///     Processes an <see cref="TagsAdded" /> event.
/// </summary>
internal class TagsAddedEventHandler : SecondLevelEventHandlerBase<TagsAdded>
{
    /// <summary>
    ///     Initializes a new instance of an <see cref="TagsAddedEventHandler" />.
    /// </summary>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (string.IsNullOrWhiteSpace(domainEvent.Id))
        {
            throw new InvalidDomainEventException(
                "Could not add tags to resource: Resource id is missing.",
                domainEvent);
        }
        ...
        {
            throw new InvalidDomainEventException(
                "Could not add tags to resource: Type of object is unknown.",
                domainEvent);
        }
        ...
        {
            throw new InvalidDomainEventException(
                "Could not add tags to resource: Tags are null or empty.",
                domainEvent);
        }
