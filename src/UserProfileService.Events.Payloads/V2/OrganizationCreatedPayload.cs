...
/// </summary>
public class OrganizationCreatedPayload : PayloadBase<OrganizationCreatedPayload>, ICreateModelPayload
{
    /// <summary>
    ...
    /// </summary>
    public TagAssignment[] Tags { set; get; } = new TagAssignment[0];
