...
/// <summary>
///     The controller is used to manage UPS-Sync scheduler operations.
/// </summary>
[ApiController]
...
{
    private readonly ILogger<SyncScheduleController> _logger;
    private readonly IScheduleService _scheduleService;

    /// <summary>
    ///     Creates an instance of the object <see cref="SyncScheduleController" />.
    /// </summary>
    /// <param name="scheduleService">The service to handle the schedule of synchronization process.</param>
    /// <param name="logger">The logger.</param>
    public SyncScheduleController(IScheduleService scheduleService, ILogger<SyncScheduleController> logger)
    {
