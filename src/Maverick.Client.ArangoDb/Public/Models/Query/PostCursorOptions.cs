...
/// <summary>
///     Contains some options that can be setted by creating a cursor
/// </summary>
public class PostCursorOptions
{
    ...
    /// <summary>
    ///     If set to <see cref="AQueryProfileType.Basic" />, then the additional query profiling information will be returned
    ///     in the sub-attribute profile of the extra return attribute, if the query result is not served
    ///     from the query cache. Set to <see cref="AQueryProfileType.Detailed" /> the query will include execution stats per
    ///     query plan node
    ...
    /// </summary>
    public AQueryProfileType? Profile { get; set; }
