...
/// <summary>
///     This message is emitted when a new organization is created.
///     BE AWARE messages in the queue should be processed/removed before an upgrade is performed.
/// </summary>
[Command(CommandConstants.OrganizationCreate)]
public class OrganizationCreatedMessage : OrganizationCreatedPayload
{
}
