...
/// <summary>
///     This event is raised when tags are removed from an function.
///     BE AWARE messages in the queue should be processed/removed before an upgrade is performed.
/// </summary>
[Command(CommandConstants.FunctionTagsRemoved)]
public class FunctionTagsRemovedMessage : TagsRemovedPayload
{
}
