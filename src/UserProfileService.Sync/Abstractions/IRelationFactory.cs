...
public interface IRelationFactory
{
    ...
    /// </summary>
    /// <param name="sourceSystemName">The source system of the relation handler.</param>
    ...
    IRelationHandler CreateRelationHandler(string sourceSystemName, string relationEntity);
}
