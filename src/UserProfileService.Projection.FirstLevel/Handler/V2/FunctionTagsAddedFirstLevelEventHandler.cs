...
/// <summary>
///     This handler is used to process <see cref="FunctionTagsAddedEvent" />.
/// </summary>
internal class FunctionTagsAddedFirstLevelEventHandler : FirstLevelEventHandlerBase<FunctionTagsAddedEvent>
{
    ...
    /// <summary>
    ///     Creates an instance of the object <see cref="FunctionTagsAddedFirstLevelEventHandler" />.
    /// </summary>
    ...
    public FunctionTagsAddedFirstLevelEventHandler(
        ILogger<FunctionTagsAddedFirstLevelEventHandler> logger,
    ...
    protected override async Task HandleInternalAsync(
        FunctionTagsAddedEvent eventObject,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        foreach (FirstLevelProjectionTag tagToAdd in tagsToAdd)
        {
            ...
            await Repository.AddTagToFunctionAsync(
