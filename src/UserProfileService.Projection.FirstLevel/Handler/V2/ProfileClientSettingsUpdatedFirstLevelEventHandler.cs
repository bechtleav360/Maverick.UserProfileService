...
/// <summary>
///     This handler is used to process <see cref="ProfileClientSettingsUpdatedEvent" />.
/// </summary>
internal class
    ProfileClientSettingsUpdatedFirstLevelEventHandler : FirstLevelEventHandlerTagsIncludedBase<ProfileClientSettingsUpdatedEvent>
{
    /// <summary>
    ///     Creates an instance of the object <see cref="ProfileClientSettingsUpdatedFirstLevelEventHandler" />.
    /// </summary>
    ...
    public ProfileClientSettingsUpdatedFirstLevelEventHandler(
        ILogger<ProfileClientSettingsUpdatedFirstLevelEventHandler> logger,
    ...
    protected override async Task HandleInternalAsync(
        ProfileClientSettingsUpdatedEvent eventObject,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        IFirstLevelProjectionProfile profileToUpdateClientSettings = await Repository.GetProfileAsync(
        ...
        Logger.LogInfoMessage(
            ...
            profileToUpdateClientSettings.ToLogString().AsArgumentList());

        IEnumerable<EventTuple> clientSettingTuple = await SetClientSettingsAndRecalculateTupleAsync(
            profileToUpdateClientSettings.ToObjectIdent(),
            transaction,
            eventObject,
        ...
        if (Logger.IsEnabledForTrace())
        {
            Logger.LogTraceMessage(
                ...
                LogHelpers.Arguments(profileToUpdateClientSettings.Id, clientSettingTuple.ToLogString()));
        }
