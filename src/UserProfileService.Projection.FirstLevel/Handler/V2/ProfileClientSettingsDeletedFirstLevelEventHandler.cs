...
/// <summary>
///     This handler is used to process <see cref="ProfileClientSettingsDeletedEvent" />.
/// </summary>
internal class
    ProfileClientSettingsDeletedFirstLevelEventHandler : FirstLevelEventHandlerTagsIncludedBase<ProfileClientSettingsDeletedEvent>
{
    /// <summary>
    ///     Creates an instance of the object <see cref="ProfileClientSettingsDeletedFirstLevelEventHandler" />.
    /// </summary>
    ...
    public ProfileClientSettingsDeletedFirstLevelEventHandler(
        ILogger<ProfileClientSettingsDeletedFirstLevelEventHandler> logger,
        IFirstLevelProjectionRepository repository,
        ISagaService sagaService,
        IMapper mapper,
        IFirstLevelEventTupleCreator creator) : base(logger, repository, sagaService, mapper, creator)
    {
    }

    protected override async Task HandleInternalAsync(
        ProfileClientSettingsDeletedEvent eventObject,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        IEnumerable<EventTuple> clientSettingTuple = await UnsetClientSettingsAndRecalculateTupleAsync(
        ...
        await RecalculatedClientSettingsForChildren(
            eventObject.Payload.Resource.ToObjectIdent(),
            transaction,
            batchSagaId,
            eventObject,
            eventObject.Payload.Key,
