...
internal class FirstLevelProjectionEventLogCollectionsProvider : ICollectionDetailsProvider
{
    ...
    public FirstLevelProjectionEventLogCollectionsProvider(string prefix)
    {
        _prefix = prefix;
    }
    ...
    {
        ModelBuilderOptions modelInfo = DefaultModelConstellation.NewEventLogStore(_prefix).ModelsInfo;
