...
///     associated ids for use by OPA.
/// </summary>
public interface ISecondLevelOpaRepository : IProjectionStateRepository
{
    /// <summary>
    ///     Gets the current opa user.
    /// </summary>
    /// <param name="userId">
    ...
    /// </returns>
    Task<SecondLevelProjectionOpaUser> GetOpaUserAsync(
        string userId,
    ...
    /// </returns>
    Task SaveOpaUserAsync(
        SecondLevelProjectionOpaUser user,
        IDatabaseTransaction transaction = null,
        CancellationToken cancellationToken = default);
