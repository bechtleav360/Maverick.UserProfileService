...
/// <summary>
///     The container organization that is used for the first level projection
///     repository.
/// </summary>
public class FirstLevelProjectionOrganization : IFirstLevelProjectionContainer, IFirstLevelProjectionProfile
{
    /// <inheritdoc />
